...
| `SearchActions` | `s:keyword` | `aa{sv}` | 按关键词搜索操作记录 |
...
CREATE TABLE actions (
    ...
    type TEXT NOT NULL,                  -- window/file/clipboard/input/system
...
- inotify watch 达到上限：记录警告日志，停止新增 watch，保留已有
